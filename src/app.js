...
setInterval(() => {
  let date = new Date();
  document.getElementById("heaer_clock").innerHTML =
...
const modalMain = new ItcModal({
  ...
  content:
    '<div style="display: flex; flex-wrap: nowrap; justify-content: space-between; height: auto; max-width: 100%;"> <div class="logo" style="height: 100px; width: 130px; margin: auto;"></div> <p style="padding-left: 20px"> <span style="font-weight: bold;">Уважаемый, Гость</span>! <br><br> Добро пожаловать в интерактивное путешествие по нашей <br> <span style="font-weight: bold;">"Коробке рандома"</span>. <br><br> Для начала работы щелкни правой кнопкой мыши в любом месте окна и "Поехали!"</p> </div> ',
  footerButtons: [
